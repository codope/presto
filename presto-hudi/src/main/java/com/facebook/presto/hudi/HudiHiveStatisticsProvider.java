        ...
        implements HiveStatisticsProvider
{
    ...
    public HudiHiveStatisticsProvider(ExtendedHiveMetastore metastore)
    {
    ...
    private static Map<String, PartitionStatistics> getPartitionsStatistics(ConnectorSession session, ExtendedHiveMetastore metastore, SchemaTableName table, List<HivePartition> hivePartitions)
    {
